(function (global, factory) {
    ...
    (global = global || self, factory(global['ngx-simple-countdown'] = {}, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var NgxSimpleCountdownDirective = /** @class */ (function () {
        ...
        NgxSimpleCountdownDirective.prototype.initSimpleCountdown = function () {
            ...
            this.createHTML();
            this.interval$ = rxjs.interval(1000).pipe(operators.takeUntil(this.componentDestroyed(this)), operators.filter(function (_) { return _this.reactive && _this.totalSecondes > 0; }), operators.tap(function (_) { return _this.totalSecondes--; }), operators.tap(function (_) {
                return (_this.countdownResult = _this.updateSimpleCountdown(_this.totalSecondes));
            }), operators.tap(function (_) { return _this.createHTML(); }));
